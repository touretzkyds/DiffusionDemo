...
def display_guidance_images(prompt, seed, num_inference_steps, guidance_values, progress=gr.Progress()):
    ...
    for i in range(num_images):  
        ...
        image = generate_images(latents, text_embeddings, num_inference_steps, guidance_scale=int(guidance_values[i]))
